...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="card-body">
            ...
            <!--Flash Data -->
            <form action="<?php echo base_url() . 'admin/barangKirim/sendBarang'; ?>" method="POST">

                <div class=" btn-toolbar mb-2" role="toolbar" aria-label="toolbar with button groups">
                    <div class=" btn-group mr-2" role="group" aria-label="First group">
                        <button id="btnAdminJakarta" type="submit" name="sendBtn" class=" btn btn-primary" data-toggle="modal" data-target="#">Kirim Barang<i class="ml-2 bi bi-send"></i></button>
                    </div>
                </div>
