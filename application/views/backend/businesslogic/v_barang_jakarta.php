        ...
        <div class="card-body">
            ...
            <div class="btn-toolbar mb-2" role="toolbar" aria-label="toolbar with button groups">
                <div class="btn-group mr-2" role="group" aria-label="First group">
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Input
                        Barang<i class="ml-2 bi bi-plus-circle"></i></button>
                </div>
            </div>
            <?php endif; ?>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form class="needs-validation" role="form" method="POST"
                                action="<?php echo base_url() . 'admin/BarangJakarta/inputBarang'; ?>" novalidate>
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tlpPengirim" name="tlpPengirim"
                                            placeholder="" required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="tlpPenerima" name="tlpPenerima"
                                            placeholder="" required>
                                        <div class="invalid-feedback">
                                            No Telepon Wajib di isi
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="alamatPenerima"
                                            name="alamatPenerima" placeholder="" required>
                                        <div class="invalid-feedback">
                                            Alamat Wajib di isi
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select" id="jeniPacking " name="jenisPacking"
                                            placeholder="Pilih Jenis Packing" required>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a
                                        href="<?php echo base_url('admin/barangdetails/detail/' . $tlj['no_resi']) ?>"><?php echo $tlj['no_resi'] ?></a>
                                </td>
