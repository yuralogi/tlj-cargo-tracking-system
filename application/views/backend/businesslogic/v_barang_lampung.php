...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <div class="card-body">
            ...
            <!--Flash Data -->
            <form action="<?php echo base_url() . 'admin/barangsampaipelanggan/arriveBarang'; ?>" method="POST">
                <?php if ($this->session->userdata('role') == 2) : ?>
                    <div class=" btn-toolbar mb-2" role="toolbar" aria-label="toolbar with button groups">
                        <div class=" btn-group mr-2" role="group" aria-label="First group">
                            <button id="btnAdminJakarta" type="submit" name="sendBtn" class=" btn btn-primary" data-toggle="modal" data-target="#">Konfirmasi<i class="ml-2 bi bi-send"></i></button>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <?php if ($this->session->userdata('role') == 1) : ?>
                        <div class="card-header">
                            <h3 class="card-title">Data Barang Lampung</h3>
                        </div>
                    <?php endif; ?>
                            ...
                            <tbody>
                                ...
                                foreach ($db_tljcargo as $tlj) :
                                    if ($tlj['status_barang'] == "SEDANG DIKIRIM") {
                                        continue;
                                    } else if ($tlj['status_barang'] == "BARANG DITERIMA DI JAKARTA") {
                                        continue;
